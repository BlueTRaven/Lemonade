...
namespace Lemonade
{
    public class RotatedRectangle
    {
        ...
        public Vector2 center { get { return CollisionRectangle.Center.ToVector2();} set { ChangePosition((int)(value.X - CollisionRectangle.Width / 2), (int)(value.Y - CollisionRectangle.Height / 2)); } }
